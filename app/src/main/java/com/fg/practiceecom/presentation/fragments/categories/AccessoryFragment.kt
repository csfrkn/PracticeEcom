...
import com.fg.practiceecom.presentation.viewmodel.factory.BaseCategoryViewModelFactory
...
class AccessoryFragment : BaseCategoryFragment() {
    ...
    val viewModel by viewModels<CategoryViewModel> {
        BaseCategoryViewModelFactory(firestore, Category.Sweatshirt)
    }
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.bestProducts.collectLatest {
                when (it) {
                    ...
                    is Resource.Success -> {
                        allProductAdapter.differ.submitList(it.data)
