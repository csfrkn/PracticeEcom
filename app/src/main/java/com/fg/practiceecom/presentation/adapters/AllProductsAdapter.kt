...
import com.fg.practiceecom.databinding.ProductRvItemBinding
import com.fg.practiceecom.helper.getProductPrice
import com.fg.practiceecom.util.Resource

class AllProductsAdapter : RecyclerView.Adapter<AllProductsAdapter.BestProductViewHolder>() {
        ...
        fun bind(product: Product) {
            binding.apply {
                ...
                if (product.offerPercentage == null) {
                    ...
                    tvPrice.setTextColor(itemView.context.resources.getColor(R.color.white))
                }else {
